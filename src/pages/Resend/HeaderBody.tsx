    ...
    return (
        <div style={{backgroundColor:'white',padding:'3vh 1vw'}}>
            ...
            <div style={{display:'flex'}}>
                ...
                <div style={{fontSize:'1.5rem',margin:'0vh 0.5vw',display:'flex',justifyContent:'center',alignItems:'center'}}>ข้อความที่ไม่ได้รับ</div>
                <div style={{fontSize:'1.5rem',margin:'0vh 0vw 0vh 25vw',display:'flex',justifyContent:'center',color:'#D21E1E',alignItems:'center'}}>5</div>
