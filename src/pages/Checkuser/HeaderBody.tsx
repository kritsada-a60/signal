...
const HeaderBody: React.FunctionComponent<IHeaderBodyProps> = (props) => {
    ...
    const Card5 = () => (
        <div>
            <div style={{backgroundColor:'#D21E1E',color:'white',width:'17.708vw',height:'14.537vh',borderRadius:'1vh',display:'flex',flexDirection:'column',textAlign:'left',lineHeight:'0.1vh',margin:'1.5vh 0.5vw',boxShadow:'0px 4px 4px rgba(0, 0, 0, 0.15)'}}>
                <p style={{margin:'3vh 0 0 2vw',fontSize:'1.5rem'}}>ข้อความที่ไม่ไ่ด้รับ</p>
                <p style={{margin:'4vh 0 0 2vw',fontSize:'1rem'}}>จำนวนข้อความ</p>
                <p style={{margin:'4vh 0 0 2vw',fontWeight:'bold',fontSize:'1.75rem'}}>5</p>
            </div>
        </div>
    ...
    return (
        <div style={{backgroundColor:'white',padding:'3vh 1vw'}}>
            <div>
                <Button onClick={navigateeditdata} style={{width:'13.698vw',height:'5.185vh',color:'#FFFFFF',backgroundColor:'#292929',borderRadius:'1vh',margin:'0vh 0.5vw',boxShadow:'0px 4px 4px rgba(0, 0, 0, 0.15)'}}>
                    ตรวจสอบ Signal M4
                </Button>
                <Button style={{width:'13.698vw',height:'5.185vh',color:'#292929',backgroundColor:'#FFFFFF',borderRadius:'1vh',margin:'0vh 0.5vw',boxShadow:'0px 4px 4px rgba(0, 0, 0, 0.15)'}}>
                    ตรวจสอบ Signal M1
                </Button>
                <Button style={{width:'13.698vw',height:'5.185vh',color:'#292929',backgroundColor:'#FFFFFF',borderRadius:'1vh',margin:'0vh 0.5vw',boxShadow:'0px 4px 4px rgba(0, 0, 0, 0.15)'}}>
                    ตรวจสอบ Signal M5
