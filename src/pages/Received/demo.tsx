            ...
            <div style={{display:'flex',marginRight:"1vw"}}>
                <p style={{display:'block'}}>
                    <div style={{width:'15vw',background:'white',display:'flex',justifyContent:'flex-end'}}>
                        จำนวนข้อความที่ได้รับแล้ว
                    </div>
                    <div style={{width:'15vw',background:'white',display:'flex',justifyContent:'flex-end',marginTop:'3vh',fontSize:'1.5rem',fontWeight:'bold',color:'#06C755'}}>
                        2
                    </div>
                </p>
